...
- ターゲット: ライブ配信で稼ぎたい女性
- トーン: 友達に話すようなカジュアルな口調。「〜だよね」「〜じゃん」「マジで」など自然な言葉遣い
- 【禁止表現】「高収入」「サポート」「無料相談」「目指しませんか？」「始めませんか？」など求人っぽい硬い表現は絶対NG
- 【OK表現】「ぶっちゃけ」「〜なんだよね」「気になる人はDMしてね」など友達感覚の表現
