...
` : '';
        ...
        // 【ステップ2】 メリット特化の投稿を作成（事務所視点）
        const finalPrompt = `
あなたはチャットレディ事務所の求人担当です。
**「${selectedBenefit.label}」** というメリットを伝える求人投稿を書いてください。

### 🏢 あなたの立場
- チャットレディ事務所のスタッフ・運営側
- 働く女性を募集している立場
- 「うちで働くとこんなメリットがあるよ」と伝える
...
### 書き出し例（事務所視点）：
- 「所属の子、通勤ゼロで月20万稼いでます」
- 「在宅で月30万稼いでる子、顔出しなしです」
- 「40代から始めて月収50万になった子もいます」
- 「子供が寝た後の2時間だけで月8万稼いでる主婦の子、所属にいます」
- 「未経験から始めて3ヶ月で月収30万になった子の話」

### ✍️ ルール
- 文字数: 200-280文字（短く刺さる）
- 事務所スタッフとして「所属の子は〜」「うちで働くと〜」という視点
- 数字を入れる（時間、金額、日数、人数など）
- 実績や事例ベースで説得力を出す
- ハッシュタグ禁止
- 2-3行ごとに空行
